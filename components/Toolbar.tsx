                ...
                <div key={item.id || idx}>
                  <button
                    ...
                    className={`w-full group flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 border ${item.id === 'layout'
                      ? 'bg-gradient-to-r from-blue-600 to-indigo-600 border-blue-400/30 text-white shadow-[0_4_15px_rgba(37,99,235,0.3)] hover:shadow-[0_4_20px_rgba(37,99,235,0.4)] hover:scale-[1.02] active:scale-[0.98]'
                      : item.highlight
