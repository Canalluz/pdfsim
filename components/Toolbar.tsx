                ...
                <div key={item.id || idx}>
                  <button
                    ...
                    className={`w-full group flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 border ${item.id === 'layout'
                      ? item.highlight
                        ? 'bg-gradient-to-br from-indigo-500 to-blue-600 border-indigo-400/50 text-white shadow-[0_0_25px_rgba(79,70,229,0.4)] scale-[1.05]'
                        : 'bg-indigo-500/10 border-indigo-500/40 text-indigo-400 hover:bg-indigo-500/20 hover:border-indigo-500/60 shadow-[0_0_20px_rgba(79,70,229,0.15)] ring-1 ring-indigo-500/20'
                      : item.highlight
                  ...
                  >
                    <div className={`p-1.5 rounded-lg transition-all duration-200 ${item.id === 'layout'
                      ? item.highlight ? 'bg-white/20 text-white' : 'bg-indigo-500/20 text-indigo-400 group-hover:bg-indigo-500/30'
                      : item.highlight
